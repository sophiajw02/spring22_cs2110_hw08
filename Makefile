...
OFILES = gba.o font.o main.o images/start_background.o images/game_background.o images/win_background.o images/lose_background.o images/blm_idle.o images/blm_attack_1.o images/blm_attack_2.o images/blm_attack_3.o images/blm_lose_1.o images/blm_lose_2.o images/bomb.o images/cactuar.o images/fire.o images/tonberry.o images/blm_cheer_1.o images/blm_cheer_2.o
